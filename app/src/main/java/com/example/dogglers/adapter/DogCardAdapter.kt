...
class DogCardAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val dogAdapterLayout = when(layout){
            GRID->LayoutInflater.from(parent.context)
                .inflate(R.layout.grid_list_item, parent, false)
            VERTICAL->LayoutInflater.from(parent.context)
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dogAgeView.text = resources?.getString(R.string.dog_age, item.age)
        holder.dogHobbiesView.text = resources?.getString(R.string.dog_hobbies, item.hobbies)
